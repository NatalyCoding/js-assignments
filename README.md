...
## Javascript Assignments  [![Build Status](https://travis-ci.org/NatalyCoding/js-assignments.svg?branch=master)](https://travis-ci.org/NatalyCoding/js-assignments)
...
And the last idea isript assignments please follow the next steps:
*  [Fork this to inure trainees to work using unit test and feel uncomfortable when programming without tests.

To start javasc repo](#user-content-how-to-fork-this-repo)
...
* Edit local README.md file and update all links (just replace all occurrences of `'NatalyCoding'` with your account name).
...
```
* Open https://github.com/NatalyCoding/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/NatalyCoding/js-assignments/builds).
